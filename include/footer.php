<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/cosmopolitan.png" alt="image"></a> </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget footer-nav mb-4">
                                                ...
                                                <ul class="hover-text-primary">
                                                    <li><a href="about.php" class="text-white">Forum</a></li>
                                                    <!-- <li><a href="#" class="text-white">Statistics</a></li> -->
                                                    <li><a href="about.php" class="text-white">Terms and Condition</a></li>
                                                    <li><a href="contact.php" class="text-white">Get Support</a></li>
                                                    <!-- <li><a href="#" class="text-white">Freqeuenly Ask Question</a></li> -->
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>KJ Somaiya College of Engineering, Vidyavihar</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 704-586-1094</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 932-143-6242</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>shreyamborah@gmail.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <!-- <div class="col-sm-12 text-center text-white"> Cosmopolitan 2022 © | Shreyam Borah </div> -->
                    <!-- <div class="col-sm-6">
                    ...
                    COSMOPOLITAN 2022 © | Created by <a href="https://www.linkedin.com/in/shreyam-b-3722121b9/">SHREYAM BORAH</a>
                    </div>
                </div>
            </div>
        </footer>