<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            <div class="top-header bg-secondary">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <ul class="top-contact list-text-white  d-table float-left">
                                <li><a href="#"><i class="fas fa-phone-alt text-primary mr-1"></i>+91 704 586 1094</a></li>
                                <!-- <li><a href="#"><i class="fas fa-envelope text-primary mr-1"></i>shreyamborah@gmail.com</a></li> -->
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <div class="top-contact ">
                                <ul class="list-text-white d-table float-mid">
                        ...
                        <div class="col-md-4">
                            <div class=" top-contact text-white float-right"> 
            ...
            <div class="main-nav secondary-nav hover-primary-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/cosmopolitan.png" alt=""></a>
