...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,bhk,stype,bedroom,floor,size,price,location,city,state,pimage,pimage1,pimage3,uid,status,totalfloor)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$floor','$asize','$price','$loc','$city','$state','$aimage','$aimage1','$aimage3','$uid','$status','$totalfloor')";
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Total Stories</label>
													<div class="col-lg-9">
